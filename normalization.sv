module normalization(input logic signed [9:0] exponent, input wire[47:0] P, output logic signed [9:0] normalized_exponent, output logic[22:0] normalized_mantissa,
