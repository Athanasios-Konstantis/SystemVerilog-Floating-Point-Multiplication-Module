...
module rounding(input wire[22:0] normalized_mantissa, input wire Guard, input wire Sticky, input wire Sign, input rounding_mode rnd, input logic signed[9:0] exponent,
